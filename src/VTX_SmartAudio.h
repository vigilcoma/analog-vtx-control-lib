...
#define SMARTAUDIO_WRITE_ZEROBYTES_AT_THE_END false //special setting for Eachine TX5258 (betaflight uses it for Smartaudio non-licensed clones) - we need to write additional zero byte at the end of command
